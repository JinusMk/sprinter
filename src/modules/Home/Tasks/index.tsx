...
const Tasks = () =>     {
    const {clearAll, isClearAllDisabled, tasks, onChange, onRemoveTask} = useLogic()
    ...
    return <div className={styles.container}>
        <div className={styles.header}>
            ...
            <Button type="secondary" disabled={isClearAllDisabled} onClick={clearAll}>Clear All</Button>
        </div>
        {tasksList}
        <Summary/>
        <AddTask />
